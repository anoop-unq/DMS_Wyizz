...
// import UserManagement from './Users/MainUsers';
...
// App.jsx - Updated with Protected ViewUser Route
import React, { useState, useEffect } from 'react';
import { BrowserRouter as Router, Route, Routes, Navigate, Outlet } from 'react-router-dom';
import { useAuthContext } from './context/AuthContext'; 
      ...
      <Routes>
        ...
        <Route element={<PrivateRoutes />}>
          <Route element={<MainLayout sidebarToggle={sidebarToggle} setSidebarToggle={setSidebarToggle} isMobile={isMobile} />}>
            ...
            {/* ADMIN / BANK ROUTES - USER MANAGEMENT */}
            <Route element={<ProtectedRoute allowedRoles={['bank', 'admin']} />}>
               <Route path="/bank-management" element={<BankManagement />} />
               <Route path="/bin-management" element={<BinManagement />} />
               <Route path="/merchant-management" element={<MerchantManagement />} />
               ...
               {/* ✅ NEW PROTECTED ROUTE: View User Details */}
               <Route path="/view-user-details/:id" element={<UserManagement />} /> 

               <Route path="/user-management/:id" element={<UserManagement />} />
               <Route path="/user-management/create-user" element={<UserManagement />} />
            </Route>
          </Route>
        </Route>
