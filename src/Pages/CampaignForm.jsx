...
// import CardNetworkType from "./CardNetworkType"; // ✅ Import New Component
...
//        discount_mccs: []
//     }, 
//     step7: { // ✅ Added Step 7 State
//        discount_card_networks: [],
//        discount_card_types: []
//     },
//     step8: {}, // ✅ Summary moved to Step 8
//   };
...
//     "Time Restrictions",
//     "MCC Config", 
//     "Card Config", // ✅ New Step 7
//     "Summary",     // ✅ Moved to Step 8
//   ];
...
//       const extraS = sponsors.filter(s => s.name !== "Bank" && s.name !== "Merchant");
...
//       const segmentNames = (d.discount_segments || []).map(s => s.segment_name || s.name);
//       const segmentIds = (d.discount_segments || []).map(s => s.id);

//       const existingMccs = d.discount_mccs || [];
      
//       // ✅ Extract Card Data
//       const existingNetworks = (d.discount_card_networks || []).map(n => n.id || n.card_network_id);
//       const existingTypes = (d.discount_card_types || []).map(t => t.id || t.card_type_id);
...
//           extraShares: extraS.map(s => ({ name: s.name, share: String(s.fund_percentage) })),
...
//             <div className="flex flex-col items-center relative z-10 mx-1" style={{ width: 64 }}> 
//               <div
...
//                     width: 26,
//                     height: 26,
//                     background: isActive ? "linear-gradient(90deg,#7B3FE4,#9B5DF7)" : "#F3F4F6",
//                     color: isActive ? "#fff" : "#6B7280",
//                     boxShadow: isActive ? "0 2px 6px rgba(123,63,228,0.18)" : "none",
//                   }}
//                 >
//                   {stepNumber}
//                 </div>
//               </div>
//               <div className={`mt-2 text-center font-medium leading-tight ${isActive ? "text-[#7B3FE4]" : "text-gray-500"}`} style={{ fontSize: "10px" }}>
//                 {label}
//               </div>
//             </div>
//             {index < steps.length - 1 && (
//               <div className="flex-1 flex items-center justify-center px-1">
//                 <div className="h-[1.5px] w-full bg-gray-200" style={{ minWidth: 20, maxWidth: 60 }} />
//               </div>
//             )}
//           </React.Fragment>
//         );
