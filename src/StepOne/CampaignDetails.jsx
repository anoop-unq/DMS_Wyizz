...
const CampaignDetails = ({
  ...
  const updateParentState = (override = {}) => {
    ...
    const isMultiVal =
      override.convertToBase !== undefined
        ? override.convertToBase
        : convertToBase;
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div className="lg:col-span-1 bg-[#F7F9FB] border border-[#E2E8F0] p-4 rounded mb-4">
          <label className="flex gap-1 block text-sm text-gray-700 mb-2">
            <img src={assets.CalendarLogo} className="w-4 h-4 mt-0.5" alt="" />{" "}
                  ...
                  <label
                    ...
                    onClick={() => {
                      if (!isAnySubmitting) {
                        ...
                        updateParentState({ campaignType: t.value });
                      }
                    }}
                    className={`flex items-center p-3 rounded-lg cursor-pointer border transition-all duration-150 ${
                      active
                        ...
                        : "bg-white text-gray-900 border border-gray-200 hover:border-[#B0B2F7]/40"
                    }`}
                  >
          ...
          <div className="flex items-center mb-4 h-[42px] relative z-20">
            ...
            <div className="relative h-full">
              <button
                ...
                className={`h-full flex items-center justify-between px-3 min-w-[130px] border border-r-0 rounded-l-md outline-none transition-colors duration-200
                  ${
                    currency
                      ? "bg-[#7747EE] text-white border-transparent relative z-10"
                      : `bg-white text-gray-900 ${getBorderClass("currency")}`
                  }
                `}
              ...
              >
                <span className="text-xs font-medium truncate mr-2">
                  {(() => {
                    ...
                    const selectedItem = currencyList.find(
            ...
            <div className="flex-1 h-full relative z-0">
              <input
                ...
                className={`w-full h-full bg-[#ffffff] border rounded-r-md px-3 text-sm outline-none ${getBorderClass(
                  "fundAmount"
                )}`}
                placeholder="5000000"
                disabled={isAnySubmitting}
      ...
      <ThirdPartyShares
        ...
        onUpdateShares={(newShares) => {
          setExtraShares(newShares);
          updateParentState({ extraShares: newShares });
        }}
        ...
        <div className="flex gap-3">
          {isEditMode && (
            <button
              ...
              disabled={isAnySubmitting}
              className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded text-sm flex items-center gap-2 disabled:opacity-70"
            >
              {isUpdateSubmitting && (
          ...
          <button
            ...
            disabled={isAnySubmitting}
            className="bg-[#6366F1] border border-[#E2E8F0] rounded-[5px] px-8 py-[5px] text-[#ffffff] text-[14px] flex items-center gap-2 disabled:opacity-70"
          >
